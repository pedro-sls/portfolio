export const siteCopy = {
  en: {
    ...
    projects: {
      ...
      title: "Public repositories and contributions selected for review.",
      ownerLabel: "Own repo",
      ...
      emptyTitle: "No featured project selected",
      emptyDescription:
        "The private curation panel controls which repositories appear here.",
    },
  ...
  pt: {
    ...
    projects: {
      ...
      title: "Repositorios publicos e contribuicoes selecionadas para revisao.",
      ownerLabel: "Proprio",
      contributionLabel: "Contribuicao",
      repositoryAction: "Repositorio",
      demoAction: "Demo",
      starsLabel: "Stars",
      forksLabel: "Forks",
      updatedLabel: "Atualizado",
      emptyTitle: "Nenhum projeto em destaque",
      emptyDescription:
        "O painel privado de curadoria controla quais repositorios aparecem aqui.",
    },
    footer: "build, measure, improve",
  },
} as const;
